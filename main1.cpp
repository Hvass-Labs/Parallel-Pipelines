/******************************************************************************
 * Example 1 shows how to make a Parallel Pipeline to calculate the following
 ...
 * buffering the result to a variable named F_buffer, and using this buffer in
 * the other thread to calculate G(F_buffer).
 * 
...
/**
 * Serial processing of a vector with elements x[i] to produce G(F(x[i]))
 * where the functions F and G are run in serial.
 * 
...
/**
 * Parallel processing of a vector with elements x[i] to produce G(F(x[i]))
 * where the functions F and G are run in parallel.
 * 
 * @param x_vec input data to be processed.
 */
